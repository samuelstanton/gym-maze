...
register(
    ...
    tags={'wrapper _config.TimeLimit.max_episode_steps': 2000},
)
...
register(
    ...
    tags={'wrapper _config.TimeLimit.max_episode_steps': 10000},
)
...
register(
    ...
    tags={'wrapper _config.TimeLimit.max_episode_steps': 1000},
)
...
register(
    ...
    tags={'wrapper _config.TimeLimit.max_episode_steps': 1000000},
)
